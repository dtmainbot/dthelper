...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const q1_Input = interaction.fields.getTextInputValue('developer_q1');
        const q2_Input = interaction.fields.getTextInputValue('developer_q2');
        const q3_Input = interaction.fields.getTextInputValue('developer_q3');
        const q4_Input = interaction.fields.getTextInputValue('developer_q4');
        const q5_Input = interaction.fields.getTextInputValue('developer_q5');

        const submitembed = new EmbedBuilder()
        .setColor(`Random`)
        .setDescription(`<a:doneemoje:1188536782770409483> <@${interaction.user.id}>: Developer Application Has been sent to review!`)

        const embeds = new EmbedBuilder()
        .setAuthor({name: interaction.guild.name, iconURL: interaction.guild.iconURL()})
        .setColor(`Random`)
        .setThumbnail(interaction.user.displayAvatarURL())
        .setTitle(`<a:devemojie:1188476396964675644> **${interaction.user.username}\`s Application For Developer!**\n`)
        .setDescription(`
        \`q1\`: **${questions.developer_q1}**
        <:arrownna:1188528432456421467> ${q1_Input}

        \`q2\`: **${questions.developer_q2}**
        <:arrownna:1188528432456421467> ${q2_Input}
        
        \`q3\`: **${questions.developer_q3}**
        <:arrownna:1188528432456421467> ${q3_Input}
        
        \`q4\`: **${questions.developer_q4}**
        <:arrownna:1188528432456421467> ${q4_Input}
        
        \`q5\`: **${questions.developer_q5}**
        ...
        <:arrowflipet:1188472519213207582>Application Type:\`Developer Application\`\n
        `)
        ...
        .addComponents(
            new ButtonBuilder()
            .setCustomId(`developer_accept`)
            .setLabel(`Accept`)
            .setStyle(3),
            new ButtonBuilder()
            .setCustomId(`developer_deny`)
            .setLabel(`Deny`)
            .setStyle(4),
            new ButtonBuilder()
            .setCustomId(`developer_accept_wr`)
            .setLabel(`Accept With Reason`)
            .setStyle(3),
            new ButtonBuilder()
            .setCustomId(`developer_deny_wr`)
            .setLabel(`Deny With Reason`)
            .setStyle(4),
            new ButtonBuilder()
            .setCustomId(`developer_blacklist`)
            .setLabel(`Blacklist`)
            .setStyle(1),
        )
